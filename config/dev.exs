...
config :calculadora, CalculadoraWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "B4xfUzeN0NkaQB+0iLWnNEvEDZX+iO/Psd/fWgge01jWVHd0z+JSMsP3s+Zs8Hl9",
  watchers: [
...
config :calculadora, CalculadoraWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/calculadora_web/(live|views)/.*(ex)$",
      ~r"lib/calculadora_web/templates/.*(eex)$"
    ]
  ]
